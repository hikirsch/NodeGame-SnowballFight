...
var init = function(EntityModel)
{
	...
	return {
		...
		iglooGreenFlag			: { initialPosition:{x:5, y:5}, collisionMask: charactersAndProjectiles, collisionOffset: {x:0, y:-5},	radius: 50, theme: '108' },
		iglooRedFlag			: { initialPosition:{x:5, y:5}, collisionMask: charactersAndProjectiles, collisionOffset: {x:0, y:-5},	radius: 50, theme: '109' },
